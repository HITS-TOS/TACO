...
peak_bag_mode_id02_r <- function(pds, peaks, data) {
    ...
    peaks <-
        peaks %>%
        tag_l02_peaks(pds = pds, DeltaNu = Dnu, d02 = d02, alpha=alpha, numax = data$numax,
    ...
    print(paste0("Final dnu: ", format(round(Dnu, 3), nsmall=3), "+/- ", format(round(Dnu_sd, 3), nsmall=3), " uHz, and eps: ", format(round(eps_p, 3), nsmall=3), "+/- ", format(round(eps_p_sd, 3), nsmall=3), ", alpha: ", format(round(alpha, 4),nsmall=3),"+/-",format(round(alpha_sd, 4), nsmall=4), ", d02: ", format(round(d02, 4))))
    ...
    print(paste0("Central dnu: ", format(round(central_Dnu, 3), nsmall=3), "+/- ", format(round(central_Dnu_sd, 3), nsmall=3), " uHz, and eps: ", format(round(central_eps_p, 3), nsmall=3), "+/- ", format(round(central_eps_p_sd, 3), nsmall=3), ", alpha: ", format(round(central_alpha, 4),nsmall=3),"+/-",format(round(central_alpha_sd, 4), nsmall=4)))
